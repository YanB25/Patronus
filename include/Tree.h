...
private:
    ...
    void unlock_addr(GlobalAddress lock_addr,
                     ...
                     int coro_id,
                     bool async);
    void write_page_and_unlock(char *page_buffer,
                               ...
                               int coro_id,
                               bool async);
    void lock_and_read_page(char *page_buffer,
                            GlobalAddress page_addr,
                            int page_size,
                            uint64_t *cas_buffer,
                            GlobalAddress lock_addr,
    ...
    void internal_page_search(InternalPage *page,
                              const Key &k,
                              SearchResult &result);
    ...
    bool leaf_page_store(GlobalAddress page_addr,
                         ...
                         int coro_id,
                         bool from_cache = false);
    void leaf_page_del(GlobalAddress page_addr,
                       const Key &k,
                       int level,
                       CoroContext *cxt,
                       int coro_id);
